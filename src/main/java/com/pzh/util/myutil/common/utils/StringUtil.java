...
public class StringUtil {
     ...
     * 3、""<br/>
     * @param str 被检测的字符串
     * @return 是否为空，true：空白，false：不是空白
     */
     ...
     * 3、不为""<br/>
     * @param str 被检测的字符串
     * @return 是否为非空，true：不是空白，false：空白
     */
     ...
     *
     * @param str 要处理的字符串
     * @param mode -1:去除头部的空白，0:trim去除全部的空白，1:trim去除尾部的空白
     ...
     * @return 是否以指定字符串开头，true:是，false:否
     */
     ...
     * @param suffix 结尾字符串
     * @param isIgnoreCase 是否忽略大小写
     * @return 是否以指定字符串结尾，true：是，false：否
     */
     ...
     * 例如：setName 返回 name
     * @param getOrSetMethodName get/set方法名
     ...
     * 获得字符串对应byte数组
     * @param str 字符串
     * @param charset 编码，如果为null使用系统默认编码
     * @return bytes
     */
    ...
    public static void main(String[] args) {
        System.out.println("首字母小写firstCharToLowerCase(Hello World->hello World)：" + firstCharToLowerCase("Hello World"));
        System.out.println("首字母大写firstCharToUpperCase(hello world->Hello world)：" + firstCharToUpperCase("hello world"));
        System.out.println("是空白isBlank：" + isBlank(" "));
        System.out.println("不是空白notBlank：" + notBlank(" "));
        System.out.println("有空白hasBlank：" + hasBlank(" ", "", "asd"));
        System.out.println("是否全空白isAllBlank：" + isAllBlank(" ", "", "asd"));
        System.out.println("是空isEmpty：" + isEmpty(" "));
        System.out.println("不是空isNotEmpty：" + isNotEmpty(" "));
        System.out.println("null变为空nullToEmpty：" + nullToEmpty(null));
        System.out.println("空变为nullemptyToNull：" + emptyToNull(""));
        System.out.println("有空hasEmpty：" + hasEmpty(" ", "", "asd"));
        System.out.println("是否全空isAllEmpty：" + isAllEmpty(" ", "", "asd"));
        System.out.println("去前后空格trim：" + trim("  123   "));
        String[] arr = new String[] {" 123 "};
        trim(arr);
        System.out.println("去字符串数组前后空格trim：" + arr[0]);
        System.out.println("去前空格trimStart：" + trimStart("   123   "));
        System.out.println("去后空格trimEnd：" + trimEnd("   123   "));
        System.out.println("是否以xx开头并忽略大小写startWith：" + startWith("XX   123   ", "xx", true));
        System.out.println("是否以XX结尾endWith：" + endWith("   123   XX", "XX", false));
    }
}
